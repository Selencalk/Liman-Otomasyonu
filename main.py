    ...
    def tir_oku(self):
        with open("olaylar.csv") as f:
            ...
            for row in reader:
                ...
                tir = Tir(plaka, ulke, yirmi_ton, otuz_ton)
            ...
            while self.istif_alani_1 or self.istif_alani_2:
                if self.istif_alani_1:
                    ...
                    if tir.ulke == gemi.gidecek_ulke:
                        ...
                        print(
                            f"{self.t}. dakikada {tir.plaka} plakalı TIRın yükü 1 numaralı istif alanından 2 numaralı "
                            f"istif alanına taşındı. ({tir.ulke})")
                else:
                    ...
                    if tir.ulke == gemi.gidecek_ulke:
                        ...
                        self.istif_alani_1_yuk += tir.yuk
                        print(
                            f"{self.t}. dakikada {tir.plaka} plakalı TIRın yükü 2 numaralı istif alanından 1 numaralı "
                            f"istif alanına taşındı. ({tir.ulke})")
